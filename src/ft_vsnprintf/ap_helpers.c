...
/*   Updated: 2017/12/16 13:53:46 by rhallste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_vsnprintf_apchar_to_str(t_format fmt, intmax_t signed_int, char *s)
{
...
void	ft_vsnprintf_apuint_helper(t_format *fmt, uintmax_t uint, char *s)
{
	char			*new;
	unsigned int	b;
